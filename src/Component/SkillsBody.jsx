...
import { RiJavascriptFill ,RiReactjsFill,RiNodejsLine} from "react-icons/ri";
  ...
  return (
    <div className='skills' id='skill'>
        ...
        <div className='row'>
            ...
            <div className="box">
                <div>
            <RiNodejsLine size={50} color="#ffff" className='box-icons'/>
                </div>
            <p>Node js</p>
            </div>
            <div className="box">
                <div>
            <SiExpress size={50} color="#ffff" className='box-icons'/>
                </div>
            <p>Express js</p>
            </div>
            <div className="box">
                <div>
            <DiMongodb size={50} color="#ffff" className='box-icons'/>
                </div>
            <p>Mongo DB</p>
            </div>
            <div className="box">
